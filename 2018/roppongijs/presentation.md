...
- しかし、バックエンドの役割のほとんどはリソース配信
  - フロント側の方がパフォーマンスに関わる要因が多い
  - 特にSPAなどのJavaScriptでUIを作るような仕組みとなっているサイトはフロント側の比率が高くなる傾向
- ウェブサイトのパフォーマンスの8-9割ぐらいはフロント側の処理の問題
...
[^note]: この分類はフロントエンドがコントロールできる領域が80-90%という意味

-----



# ネットワーク/バックエンド/フロントエンド
