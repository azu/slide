...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchImage = __webpack_require__(/*! ./fetchImage */ 1);
	/**
	 * @typedef {{imageMapList : ImageMap, delimit: object}} ImageMeta
	 */
	...
	function encodePuzzle(canvas, image) {
	    ...
	    __webpack_require__(/*! ./canvasUtil */ 3).fitCanvasWithImage(canvas, image);
	    var shuffled = __webpack_require__(/*! shuffle-array */ 5)(mapAndDataURLs);
	    return writeImageDataMap(canvas, shuffled).then(function () {
	        return {
	            canvas: canvas,
	            imageMeta: {
	                imageMapList: shuffled,
	                delimit: __webpack_require__(/*! ./const-col-row */ 4)
	            }
	        }
	    });
	}
	...
	function getImageMap(canvas, image) {
	    var NUM_COLS = __webpack_require__(/*! ./const-col-row */ 4).cols,
	        NUM_ROWS = __webpack_require__(/*! ./const-col-row */ 4).rows;
	...
	function writeImageDataMap(canvas, imageMapList) {
	    ...
	    var imagePromises = imageMapList.map(function (dataMap) {
	        var promise = fetchImage(dataMap.dataURL);
	        delete dataMap.dataURL;
	        return promise;
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! (webpack)/buildin/module.js */ 7)(module), (function() { return this; }())))
...
/***/ }
/******/ ])
//# sourceMappingURL=encode-app.js.map