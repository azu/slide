...
- 前回の続き? : [JavaScriptのアーキテクチャ](http://azu.github.io/slide/2016/make-arch/js-css-architecture.html "JavaScriptのアーキテクチャ")
...
- StoreGroupというStoreを取りまとめる層を置いてる
	- Storeが一斉に更新通知を出した時にStoreGroupが間引いて1回の更新通知としてViewに伝える
	- 全部の通知が行くとUIで間引く必要があるため
- Storeは2種類の更新方法がある
	- UseCaseからのdirect dispatch
	- Repositoryの更新通知からの更新
...
- Storeの構造化はどうするか迷ってる
- 2種類の更新通知をどうまとめるか、まとめないか
	- 手当たりしだいにイベントを監視するとStoreが複雑化しそう
- Flux utilやReduxのStoreをアイデアを適応するかどうか
